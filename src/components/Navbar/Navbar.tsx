...
const Navbar = () => {
  ...
  > */}
      ...
      >
        ...
        <div
          className={`min-h-full px-3 rounded-full absolute mx-auto left-0 right-0 w-fit my-auto  flex-row  gap-2 items-center hidden lg:flex py-2  ${show ? " text-primary-content" : "text-primary-content"
            } `}
        >
          <Menu />
        </div>
        ...
        <div className="  flex items-center gap-2   ">
          ...
          {/* Mobile menu end */}
          <div
            className={`hidden lg:block ${show ? " text-primary-content" : " text-black"
              }`}
          >
            <LoginButton />{" "}
          </div>
